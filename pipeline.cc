...
void pipeline::add_stage(Stage st, const void* ctx) {
    ...
    switch (st) {
        case shortcircuit_srcover_both_srgb: n = ::shortcircuit_srcover_both_srgb; break;
