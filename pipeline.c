...
void load_srgb_dst(struct stage* stage, void* dp, const void* sp, const void* cp,
    ...
    stage->next->fn(stage->next, dp,sp,cp,d,s,n);
}

void load_srgb_src(struct stage* stage, void* dp, const void* sp, const void* cp,
                   __m128 d, __m128 s, int n) {
    const int* src = sp;
    sp = src+1;
...
void srcover(struct stage* stage, void* dp, const void* sp, const void* cp,
             __m128 d, __m128 s, int n) {
...
void lerp_a8_cov(struct stage* stage, void* dp, const void* sp, const void* cp,
                 __m128 d, __m128 s, int n) {
    const char* cov = cp;
    cp = cov+1;
...
void store_srgb(struct stage* stage, void* dp, const void* sp, const void* cp,
                __m128 d, __m128 s, int n) {
    int* dst = dp;
    dp = dst+1;
